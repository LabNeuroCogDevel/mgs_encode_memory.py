...
taskstr="cue=[2];vgs=[2](NearLeft,NearRight,Left,Right * Indoor, Outdoor,None); dly=[15x 6, 7x 8, 2x 10]; mgs=[2]"
genTaskTime  -o mri -i 1000 "<420/24 stepsize:2 iti:2-8 pad:8+8> $taskstr"
genTaskTime  -o eeg -i 10   "<358/24 stepsize:.5 iti:1.5-2.5 iti_never_first> $taskstr"
